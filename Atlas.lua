...
do
    function Library.new(info)
        ...
        local function makeLibrary()
            ...
            Converted["_B"].Text = "Atlas UI Lib: Nguyen Dep Zai Remake (cre:RoadToGlory#9879)" -- please don't remove this, this is open sourced and I leave this here so that users can know the name of the UI library if they are interested in it
...
print("Atlas Reamke UI Library v"..VERSION.." by Nguyen Dep Zai Remake (cre:RoadToGlory#9879) has initiated")
