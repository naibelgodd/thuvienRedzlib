...
local Library = {
	Themes = {
		...
		Purple = {
            ...
            Tertiary = Color3.fromRGB(150, 0, 255),

            StrongText = Color3.fromHSV(0.78, 1, 1),
            WeakText = Color3.fromRGB(180, 100, 255)
        },
		Dark = {
...
function Library:create(options)
	...
	creditsTab:credit{Name = "Nguyên(cu to)", Description = "Create This Script", Discord = "_notthingni", V3rmillion = "Ko có"}
	creditsTab:credit{Name = "Nguyên(cu to)", Description = "Create This Script", Discord = "_notthingni", V3rmillion = "Ko có"}
	creditsTab:credit{Name = "Nguyên(cu to)", Description = "Create This Script", Github="https://github.com/naibelgodd"}
